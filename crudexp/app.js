...
var dealModule = require('./routes/dealController.js');
var dealModel = require('./model/dealModel.js');
...
app.get('/deallist', function(req,res){
  ...
  dealModule.dealListMethod(req,res);  
...
app.post('/adddeal',function(req,res){
    dealModule.dealAddMethod(req,res);

}); 


// app.post('/adddeal',function(req,res){
//     dealModule.dealAddMethod(req.body,function(res));
// })

app.post('/deletedeal',function(req,res){

 dealModel.dealDelete(req,function(err,res){
